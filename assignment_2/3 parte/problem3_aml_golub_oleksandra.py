# -*- coding: utf-8 -*-
"""problem3_aml_golub_oleksandra.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1maDE-5t-HFFHCI9Ktjr90iqQzdpXwW6B

## **Advanced Machine Learning (Assignment 2, Problem 3)**
---
---
...
# Path della cartella
drive_folder = '/content/drive/MyDrive/Assignment 2 AML/problem 3'
...
if os.path.exists(drive_folder):
    ...
    print("\nCopia file in corso...")
    files_to_copy = {
        'problem_three.weights.h5': 'problem_three.weights.h5',
        'Problem 3_accuracy.png': 'original_accuracy.png',
        'Problem 3_loss.png': 'original_loss.png',
        'problem_three (1).png': 'architecture.png'
    }
...
try:
    model_problematic.load_weights('problem_three.weights.h5')
...
def create_model_problem3_fixed():
    reg = R.l2(1e-4)  # <-- qui la correzione
    return keras.Sequential([
        layers.Dense(512, activation='relu', input_shape=(784,),
                     kernel_regularizer=reg, name='layer-one'),
        layers.Dense(128, activation='relu', kernel_regularizer=reg, name='layer-two'),
        layers.Dense(64,  activation='relu', kernel_regularizer=reg, name='layer-three'),
        layers.Dense(10,  activation='softmax', name='layer-four')
    ])

model_fixed = create_model_problem3_fixed()
model_fixed.compile(optimizer=keras.optimizers.Adam(1e-3),
                    loss='sparse_categorical_crossentropy',
                    metrics=['accuracy'])
history_fixed = model_fixed.fit(x_train, y_train, batch_size=128, epochs=10,
